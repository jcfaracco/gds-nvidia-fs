...
A Linux kernel module that enables direct I/O between GPU memory and storage devices, bypassing CPU memory copies for maximum performance. This is the upstream-aligned version to anticipate changes in the API.
...
git clone https://github.com/jcfaracco/gds-nouveau-fs.git
cd gds-nouveau-fs/src
